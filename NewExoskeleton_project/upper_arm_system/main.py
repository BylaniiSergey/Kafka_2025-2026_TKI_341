...
DATABASE_URL = 'sqlite:///upper_arm.db'
...
JOINTS_CONFIG = {
    'shoulder_flexion': {
        'min_angle': -45, 'max_angle': 180, 'max_speed': 60
    },
    'shoulder_abduction': {
        'min_angle': 0, 'max_angle': 180, 'max_speed': 50
    },
    'shoulder_rotation': {
        'min_angle': -90, 'max_angle': 90, 'max_speed': 45
    }
}
...
app = FastAPI(title="Upper Arm System", version="2.0")
...
def emergency_stop():
    ...
    return {'message': 'Upper arm emergency stop activated'}
...
def reset():
    ...
    return {'message': 'Upper arm system reset'}
