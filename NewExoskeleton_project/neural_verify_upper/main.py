...
app = FastAPI(
    title="Neural verify — upper limbs", version="1.1"
)
...
def session_init(body: SessionInit):
    ...
    _last = None
    logger.info(
        "Session patient registered for upper neural verify"
    )
    return {
        "ok": True,
