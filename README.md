...
| # | Негативный сценарий                                 | Описание                                                                                                                                                                                           | Идентификаторы угроз |
|---|-----------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------|
...
| 6 | Искажение интерпретации осязаемых предметах         | Вредоносное ПО изменило алгоритм преобразования информации о осязаемой предмете к тактильным сигналам пациенту, что привело к неправильной интерпретации осязаемого предмета.                                    | ЦБ6                  |
