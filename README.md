...
| № | Наименование угрозы | Описание | Код угрозы |<br><br>
|:---|:---|:---|:---|<br><br>
| 1 | Подмена команды через канал связи | Злоумышленник перехватил беспроводной канал связи и внедрил поддельную команду движения, которую система управления экзоскелета приняла как аутентичную. | ЦБ1 |<br><br>
| 2 | Компрометация системы управления | Вредоносное ПО внедрено в систему управления экзоскелета, в результате чего игнорируются сигналы остановки от системы мониторинга. | ЦБ2 |<br><br>
