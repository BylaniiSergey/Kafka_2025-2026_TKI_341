...
| **Исходный компонент** | **Декомпозиция** |
| --- | --- |
| Связь | Связь |
|  | Модуль расшифрования |
|  | Модуль крипто шифрования |
|  | Модуль проверки команд |
|  | Данные об экзоскелете и пациенте |
| Система управление экзоскелета | Оркестратор задач |
|  | Аварийный модуль управления |
|  | Центральная система управления |
| Система открытия и закрытия кабины | Система открытия и закрытия кабины |
|  | Модуль аварийного открытия |
| Система контроля температуры внутренней части | Система измерения температуры внутренней части |
|  | Система терморегуляции |
| Система считывания нейронных сигналов верхних конечностей | Система считывания нейронных сигналов верхних конечностей |
|  | Модуль верификации нейронных сигналов верхних конечностей |
| Модуль отправки тактильных сигналов человеку | Модуль отправки тактильных сигналов человеку |
|  | Модуль верификации и ограничения тактильных сигналов |
| Контроллер заряда батареи | Контроллер заряда батареи |
|  | Критичный заряд батареи |
| Система мониторинга | Система мониторинга |
|  | Модуль распознавания критической ситуации |
|  | Навигация ИНС |
|  | Навигация GNSS |
|  | Модуль проверки положения |
| Система контроля силы | Система контроля силы и ограничений ног |
| Датчики-сенсоры | Датчики-сенсоры |
|  | Модуль верификации показаний датчиков |
| Модуль остановки | Модуль аварийной остановки |
