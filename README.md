...
| № | Наименование угрозы | Описание | Код угрозы |<br>
|:---|:---|:---|:---|<br>
...
| 2 | Компрометация системы управления | Вредоносное ПО внедрено в систему управления экзоскелета, в результате чего игнорируются сигналы остановки от системы мониторинга. | ЦБ2 |<br>
